  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex h-full w-full max-w-full flex-col overflow-hidden">
        {/* Top bar */}
        <header className="w-full max-w-full overflow-hidden px-4 pt-3 sm:px-6 md:px-10 lg:pt-8">
          <div className="mx-auto flex w-full max-w-6xl items-start justify-between gap-2 sm:gap-4">
            ...
            >
              <img
                ...
                className="size-11 max-w-full rounded-full border-2 border-[#5B2EFF]/30 object-contain sm:size-16 md:size-20 lg:size-24"
              />
            </div>
            ...
            >
              <h2 className="max-w-full break-words font-sans text-[clamp(0.9rem,3.8vw,2.2rem)] font-bold uppercase leading-tight tracking-[0.01em] text-[#E0E7FF]">
                SBM College of Engineering & Technology
              </h2>
              <p className="mt-0.5 max-w-full break-words font-body text-[clamp(0.62rem,2.2vw,0.9rem)] leading-snug text-[#C7D2FE]">
                Approved by AICTE, New Delhi and Affiliated to Anna University - Chennai
              </p>
              <p className="max-w-full break-words font-body text-[clamp(0.62rem,2.2vw,0.9rem)] leading-snug text-[#C7D2FE]">
                SBM Nagar, Thamaraipadi, Trichy Road, Dindigul - 624005
              </p>
              <div className="mt-2.5 space-y-0.5 sm:mt-3">
                <p className="max-w-full break-words font-sans text-[clamp(0.66rem,2.4vw,1.1rem)] font-bold uppercase leading-tight tracking-[0.005em] text-[#C7D2FE]">
              ...
              <p className="mt-1 max-w-full break-words font-body text-[clamp(0.72rem,2.6vw,1rem)] italic leading-snug text-[#C7D2FE]/70">
                Proudly presents
              </p>
            </div>
            ...
            >
              <img
                ...
                className="mx-auto size-11 max-w-full rounded-full border-2 border-[#5B2EFF]/30 object-contain sm:size-16 md:size-20 lg:size-24"
              />
        ...
        <section className="relative flex min-h-[100svh] w-full items-center overflow-hidden">
          <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 md:px-10">
            <div className="flex flex-col items-start gap-6">
              ...
              >
                <h1
                  className={`${inceptionTitle.className} max-w-full break-words text-[clamp(2.5rem,9vw,6rem)] font-normal uppercase leading-tight tracking-wide text-[#f0f0ff] drop-shadow-[0_0_30px_rgba(127,90,240,0.5)]`}
                >
                  AKKADIANZ
                ...
                <p className="mt-2 max-w-full break-words font-sans text-[clamp(0.95rem,3.5vw,1.2rem)] font-bold uppercase tracking-[0.15em] leading-relaxed text-[#c8b8e8]">
              ...
              >
                <div className="flex w-full flex-col gap-4 sm:w-auto sm:flex-row">
                  <button
                    onClick={handleEnter}
                    className="group animate-pulse-glow relative inline-flex w-full items-center justify-center gap-2 overflow-hidden rounded-lg border border-[#7F5AF0]/60 bg-[#5B2EFF]/20 px-6 py-2.5 text-center font-sans text-[12px] font-bold uppercase tracking-[0.2em] text-[#E8E0F0] shadow-[0_0_22px_rgba(127,90,240,0.35)] backdrop-blur-sm transition-all duration-300 hover:border-[#00D4FF]/70 hover:bg-[#5B2EFF]/35 hover:shadow-[0_0_55px_rgba(0,212,255,0.35)] hover:scale-105 sm:w-auto sm:px-10 sm:py-3 sm:text-[14px] sm:tracking-[0.3em] md:px-14 md:py-4 md:text-[19px]"
                  >
